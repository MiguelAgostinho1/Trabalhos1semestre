...
fun addRightBlocksToList():List<Blocks>{
    var rightStarting: List<Blocks> = emptyList()
    for (i: Int in 0..2) {
...
fun addLeftBlocksToList():List<Blocks>{
    var leftStarting: List<Blocks> = emptyList()
    for (i: Int in 0..2) {
...
fun addCenterBlocksToList():List<Blocks>{
    var centerStarting: List<Blocks> = emptyList()
    centerStarting = centerStarting + createBlocks(BLOCK_WIDTH*5,BLOCK_HEIGHT + BLOCK_HEIGHT*3, 1, WHITE) +
